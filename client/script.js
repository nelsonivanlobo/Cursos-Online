...
const createCheckoutButton = (preferenceId) => {
    const bricksBuilder = mp.bricks(); // Mercado Pago Bricks initialization
    const renderComponent = async () => {
        if (window.checkoutButton) window.checkoutButton.unmount(); // Avoid generating multiple buttons
